...
conectaBancoDeDados() //chamando a função que conecta o banco do dados
...
app.use(router.get('/mulheres',mostraMulheres)) //confugurei a rota GET/mulheres
